...
namespace SISECommerce.IdentityServer
{
    public static class Config
    {
        ...
        public static IEnumerable<ApiResource> ApiResources => new ApiResource[]
        {
            ...
            new ApiResource("resource_payment") { Scopes = {"paymnet_fullpermission"}},
        ...
        public static IEnumerable<ApiScope> ApiScopes =>
            new ApiScope[]
            {
                ...
                new ApiScope("paymnet_fullpermission", "Paymnet API için full erişim"),
