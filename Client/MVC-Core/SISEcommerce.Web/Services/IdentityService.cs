...
namespace SISEcommerce.Web.Services
{
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<TokenResponse> GetAccessTokenByRefreshToken()
        {
            ...
            var token = await _htppclient.RequestRefreshTokenAsync(refreshTokenRequest);
            if (token.IsError)
            {
                return null;
            }
        ...
        public async Task RevokeRefreshToken()
        {
            ...
            await _htppclient.RevokeTokenAsync(tokenRevocationRequest);
        ...
        public async Task<Response<bool>> SignIn(SigninInput signinInput)
        {
            ...
            var token = await _htppclient.RequestPasswordTokenAsync(passwordTokenRequest);
            if (token.IsError)
            {
            ...
            var userInfo = await _htppclient.GetUserInfoAsync(userInfoRequest);
            if (userInfo.IsError)
            {
